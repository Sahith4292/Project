...
// Fetch all registered teams from the database
$sql = "SELECT team_number, created_by, member1, member2, member3 FROM teams";
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo $row['member1'] ? $row['member1'] : 'N/A'; ?></td>
                            <td><?php echo $row['member2'] ? $row['member2'] : 'N/A'; ?></td>
                            <td><?php echo $row['member3'] ? $row['member3'] : 'N/A'; ?></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
